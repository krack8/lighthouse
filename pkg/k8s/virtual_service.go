...
func (p *GetVirtualServiceListInputParams) Process(c context.Context) error {
	...
	virtualServiceClient := cfg.GetNetworkingV1Beta1ClientSet().VirtualServices(p.NamespaceName)
	limit := cfg.PageLimit
	if p.Limit != "" {
...
func (p *GetVirtualServiceDetailsInputParams) Process(c context.Context) error {
	...
	virtualServicesClient := cfg.GetNetworkingV1Beta1ClientSet().VirtualServices(p.NamespaceName)
...
func (p *DeployVirtualServiceInputParams) Process(c context.Context) error {
	VirtualServiceClient := cfg.GetNetworkingV1Beta1ClientSet().VirtualServices(p.VirtualService.Namespace)
