...
func (m *TaskStreamRequest) GetPayload() isTaskStreamRequest_Payload {
	if m != nil {
		return m.Payload
	}
	return nil
...
func (x *TaskStreamRequest) GetWorkerInfo() *WorkerIdentification {
	if x, ok := x.GetPayload().(*TaskStreamRequest_WorkerInfo); ok {
		return x.WorkerInfo
	}
	return nil
}
...
func (x *TaskStreamRequest) GetTaskResult() *TaskResult {
	if x, ok := x.GetPayload().(*TaskStreamRequest_TaskResult); ok {
		return x.TaskResult
	}
	return nil
}
...
func (m *TaskStreamResponse) GetPayload() isTaskStreamResponse_Payload {
	if m != nil {
		return m.Payload
	}
	return nil
...
func (x *TaskStreamResponse) GetNewTask() *Task {
	if x, ok := x.GetPayload().(*TaskStreamResponse_NewTask); ok {
		return x.NewTask
	}
	return nil
}
...
func (x *TaskStreamResponse) GetAck() *Ack {
	if x, ok := x.GetPayload().(*TaskStreamResponse_Ack); ok {
		return x.Ack
	}
	return nil
}
...
var file_pkg_common_pb_controller_proto_rawDesc = []byte{
	...
	0x12, 0x02, 0x70, 0x62, 0x22, 0x8e, 0x01, 0x0a, 0x11, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x72,
	...
	0x74, 0x61, 0x73, 0x6b, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61,
	0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x54, 0x0a, 0x14, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x49,
	...
	0x52, 0x09, 0x61, 0x75, 0x74, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x57, 0x0a, 0x0a, 0x54,
	...
	0x74, 0x70, 0x75, 0x74, 0x22, 0x63, 0x0a, 0x12, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x25, 0x0a, 0x08, 0x6e, 0x65,
	0x77, 0x5f, 0x74, 0x61, 0x73, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x70,
	0x62, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x48, 0x00, 0x52, 0x07, 0x6e, 0x65, 0x77, 0x54, 0x61, 0x73,
	0x6b, 0x12, 0x1b, 0x0a, 0x03, 0x61, 0x63, 0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x07,
	0x2e, 0x70, 0x62, 0x2e, 0x41, 0x63, 0x6b, 0x48, 0x00, 0x52, 0x03, 0x61, 0x63, 0x6b, 0x42, 0x09,
	0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x44, 0x0a, 0x04, 0x54, 0x61, 0x73,
	...
	0x32, 0x4d, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x12, 0x3f,
	0x0a, 0x0a, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x15, 0x2e, 0x70,
	0x62, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x70, 0x62, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x42,
	0x0f, 0x5a, 0x0d, 0x70, 0x6b, 0x67, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x70, 0x62,
...
var file_pkg_common_pb_controller_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_pkg_common_pb_controller_proto_goTypes = []interface{}{
...
var file_pkg_common_pb_controller_proto_depIdxs = []int32{
	...
	4, // 2: pb.TaskStreamResponse.new_task:type_name -> pb.Task
	5, // 3: pb.TaskStreamResponse.ack:type_name -> pb.Ack
	0, // 4: pb.Controller.TaskStream:input_type -> pb.TaskStreamRequest
	3, // 5: pb.Controller.TaskStream:output_type -> pb.TaskStreamResponse
...
func file_pkg_common_pb_controller_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_common_pb_controller_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_common_pb_controller_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WorkerIdentification); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_common_pb_controller_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_common_pb_controller_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pkg_common_pb_controller_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Task); i {
			case 0:
				return &v.state
			case 1:
		...
		file_pkg_common_pb_controller_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Ack); i {
			case 0:
				return &v.state
			case 1:
	...
	file_pkg_common_pb_controller_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*TaskStreamRequest_WorkerInfo)(nil),
		(*TaskStreamRequest_TaskResult)(nil),
	}
	file_pkg_common_pb_controller_proto_msgTypes[3].OneofWrappers = []interface{}{
