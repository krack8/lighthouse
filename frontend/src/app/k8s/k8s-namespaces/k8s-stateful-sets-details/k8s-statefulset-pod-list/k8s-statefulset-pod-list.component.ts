...
@Component({
  selector: 'kc-k8s-statefulset-pod-list',
  templateUrl: './k8s-statefulset-pod-list.component.html',
  styleUrls: ['./k8s-statefulset-pod-list.component.scss']
})
export class K8sStatefulsetPodListComponent implements OnInit {
  ...
  getPodList(queryParams?: any): void {
    ...
    this.namespaceService.getNamespaceStatefulsetsPodList(this.requestData, queryParams).subscribe({
      next: res => {
